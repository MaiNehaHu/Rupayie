...
const WhenPicker = ({
  ...
  const [hour, setHour] = useState<number>(parseInt(splittedHour, 10));
  const [minute, setMinute] = useState<number>(parseInt(splittedMinute, 10));
  const [amPm, setAmPm] = useState<string>(splittedPeriod);
